...
derivededitvaluemeasure_h=Resource(EditDerivedValueMeasureHandler)
...
collections_h=Resource(CollectionsHandler)
...
url(r'^derived/editvaluemeasure/$', derivededitvaluemeasure_h),
...
url(r'^dhbd/collections/$', collections_h)
